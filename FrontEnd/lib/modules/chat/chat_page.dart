...
class _ChatPageState extends State<ChatPage> {
  ...
  // IDs como String para compatibilidade com o Firestore (backend).
  // Substitua pelos IDs reais dos documentos do Firestore quando disponíveis.
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      final url = Uri.parse('$kBaseUrl/chat');
      ...
      if (response.statusCode == 200) {
        ...
        if (itensParaAdicionar.isNotEmpty) {
          for (var item in itensParaAdicionar) {
            final String idProduto = item['id'].toString();
