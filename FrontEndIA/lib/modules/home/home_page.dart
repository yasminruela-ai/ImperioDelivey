...
import '../chat/chat_page.dart'; // Import da tela de chat da IA
...
class HomePage extends StatelessWidget {
  ...
  SliverAppBar _buildAppBar(BuildContext context) {
    return SliverAppBar(
      expandedHeight: 140, // Altura expandida para caber o botão da IA
      pinned: true,
      elevation: 0,
      ...
      // Adicionando o botão da IA na parte inferior do SliverAppBar
  ...
  Widget _buildAIAssistantButton(BuildContext context) {
    return InkWell(
      onTap: () {
        // Ao clicar, o usuário é direcionado para a tela de chat
        Navigator.push(
          context,
  ...
  SliverList _buildProductsList() {
    return SliverList(
      delegate: SliverChildBuilderDelegate((context, index) {
        return ProductCard(product: products[index], cartKey: cartIconKey);
