...
class FlyToCart {
  static void animate({
    ...
    final endPosition = cartBox.localToGlobal(cartBox.size.center(Offset.zero));
...
class _FlyWidgetState extends State<_FlyWidget>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (_, _) {
        final x = lerpDouble(widget.start.dx, widget.end.dx, _animation.value)!;
        final y = lerpDouble(widget.start.dy, widget.end.dy, _animation.value)!;
        ...
        return Positioned(
          ...
          child: Transform.scale(
            ...
            child: Opacity(
              ...
              child: Image(image: widget.image, width: 48, height: 48),
            ),
          ),
        );
      },
